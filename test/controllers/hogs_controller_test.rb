...
class HogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hog" do
    assert_difference('Hog.count') do
      post hogs_url, params: { hog: { greased: @hog.greased, image: @hog.image, medal: @hog.medal, name: @hog.name, specialty: @hog.specialty, weight: @hog.weight } }, as: :json
    end
  ...
  test "should update hog" do
    patch hog_url(@hog), params: { hog: { greased: @hog.greased, image: @hog.image, medal: @hog.medal, name: @hog.name, specialty: @hog.specialty, weight: @hog.weight } }, as: :json
    assert_response 200
  end

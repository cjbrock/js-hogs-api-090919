...
class PigletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piglet" do
    assert_difference('Piglet.count') do
      post piglets_url, params: { piglet: { cuteness: @piglet.cuteness, hog_id: @piglet.hog_id, name: @piglet.name } }, as: :json
    end
  ...
  test "should update piglet" do
    patch piglet_url(@piglet), params: { piglet: { cuteness: @piglet.cuteness, hog_id: @piglet.hog_id, name: @piglet.name } }, as: :json
    assert_response 200
  end
